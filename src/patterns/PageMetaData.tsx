...
export function PageMetaData(props: PageMetaDataProps): JSX.Element {
  return (
    <Head>
      {/* Default favicon for light mode */}
      <link
        rel="icon"
      ...
      <link
        rel="icon"
        href="/static/icons/favicon-dark.ico"
        type="image/x-icon"
        sizes="32x32"
      ...
      <meta name="twitter:domain" content="www.ruminer.app" />
      ...
      {props.metaTags?.map((metatag, i) => <meta key={i} {...metatag} />)}
    </Head>
  );
}
