...
import { StyledAnchor, StyledText } from "./StyledText";
...
export default function IOSInstallHelp({
  ...
  return (
    ...
    >
      ...
      >
        With the native Ruminer for iOS and macOS app installed you can save any
        link, read offline, and listen to your saved items using text-to-speech.
      </StyledText>
      <HStack
        alignment="center"
        css={{
      ...
      >
        ...
        >
          <a
            href="https://www.ruminer.app/install/ios"
            target="_blank"
            rel="noreferrer"
